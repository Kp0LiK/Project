...
$header .= "From: Новая заявка <190107058@stu.sdu.edu.kz>\n\n";	
$mail = mail("190107058@stu.sdu.edu.kz", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
